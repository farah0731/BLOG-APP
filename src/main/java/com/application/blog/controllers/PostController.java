...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPost(			
	         ...
	         @RequestParam(value = "sortDir", defaultValue = AppConstants.SORT_DIR, required = false) String sortDir // Added this
			)
	{			
	...
	//update post
		...
		public ResponseEntity<PostDto> uploadPostImage(
		        ...
		        @PathVariable Integer postId) throws IOException { // Correctly declare postId as a PathVariable

		    PostDto postDto = this.postService.getPostById(postId);
		    String fileName = this.fileService.uploadImage(path, image);		    
		    postDto.setImageName(fileName); // Set the image name in the PostDto
		    PostDto updatePost=  this.postService.updatePost(postDto, postId);
		    return new ResponseEntity<PostDto>(updatePost, HttpStatus.OK); // Return the response
		}
